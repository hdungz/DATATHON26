...
Nhấn **Run All** → Sau khi notebook `datathon26.ipynb` chạy xong, kết quả `submission.csv` sẽ xuất hiện trong tab **Output** của Kaggle.
...
**Đối với `datathon26.ipynb` và `notebookmcq.ipynb`:**
```python
# Đổi từ:
...
1. **Notebook dự đoán – `datathon26.ipynb`**
   - Chạy lệnh: `jupyter notebook datathon26.ipynb`
